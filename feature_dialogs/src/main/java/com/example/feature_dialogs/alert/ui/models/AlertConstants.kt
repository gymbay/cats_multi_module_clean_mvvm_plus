...
object AlertConstants {
    ...
    const val ALERT_DIALOG_BUTTON_CONFIRM_RESULT = "ALERT_DIALOG_BUTTON_CONFIRM_RESULT"
    const val ALERT_DIALOG_BUTTON_CANCEL_RESULT = "ALERT_DIALOG_BUTTON_CANCEL_RESULT"
}